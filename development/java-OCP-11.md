...
**Q** :  *All variables inherit java.lang.Object.*  
**A** : **İncorrect** because primitive types do not inherit java.lang.Object.
...
```java
var out = Stream.iterate(1, x -> x++)
                .limit(5).map(x -> x + "")
                .collect(Collectors.joining());

System.out.println("out = " + out); // 11111
```


```java
var out = Stream.iterate(1, x -> ++x)       // attention !!!!!
                .limit(5).map(x -> x + "")
                .collect(Collectors.joining());
